...
if __name__ == '__main__':
    ...
    folder_path = r'/mnt/d/Malware program/train_exe/benign'  # 替换为您的文件夹路径
    output_csv_path = r'/mnt/d/Malware program/CFG/edges.csv'  # 替换为您的输出CSV文件路径
    mulu=r"/mnt/d/Malware program/CFG_malware"
    malware_shaixuan_list = list(get_sample_list_from_csv(csv_save_path=r"/mnt/d/Malware program/CFG特征赋予/malware_msg_last.csv"))
