...
if __name__ == '__main__':
    ...
    folder_path = r'Z:\SOREL-20M\armed'  # 替换为您的文件夹路径
    mulu = r"\\ZJNU-NSR\Malware\SOREL-20M\CFG_malware"
    output_csv_path = r'\\ZJNU-NSR\Malware\SOREL-20M\CFG_malware\edges.csv'  # 替换为您的输出CSV文件路径
    ...
    malware_shaixuan_list = list(get_sample_list_from_csv(csv_save_path=r"\\ZJNU-NSR\Malware\SOREL-20M\cleaned_file.csv"))
